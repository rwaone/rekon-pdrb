                            ...
                            @foreach ($daftar_1 as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('lapangan-usaha.detail', ['period_id' => $item->period->id, 'region_id' => $item->region_id, 'quarter' => 'Y']) }}"
                                ...
                                @foreach ($daftar_2 as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('lapangan-usaha.detail', ['period_id' => $item->period->id, 'region_id' => $item->region_id, 'quarter' => $item->quarter]) }}"
                                                class="btn btn-primary">
                                                <span class="bi bi-check2-square"></span>
                                            </a>
                                        </td>
