            ...
            <div class="card-body">
                ...
                <nav class="navbar justify-content-center">
                    <ul class="nav nav-tabs d-flex">
                        ...
                        <a class="nav-item nav-link" id="nav-laju-cumulative" href="">Laju Implisit (C to
                            C)</a>
                    </ul>
                </nav> --}}
                            ...
                            <table class="table table-bordered" id="rekon-view">
                                ...
                                <tbody>
                                    @foreach ($subsectors as $index => $item)
                                        @if (
                                            ($item->code != null && $item->code == 'a' && $item->sector->code == '1') ||
                                                ($item->code == null && $item->sector->code == '1'))
                                            <tr>
                                                <td id="purpose-categories-{{ $index + 1 }}" class="text-bold">
                                                </td>
                                    ...
                                    <tr class="PDRB-footer text-right"
                                        ...
                                        @foreach ($regions as $region)
                                            <td id="total-nonmigas-{{ $region->id }}" style="margin-bottom:0rem;">
                                            </td>
                                        @endforeach
                                    </tr>
                                    <tr class="PDRB-footer text-right"
