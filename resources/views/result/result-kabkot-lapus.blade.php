        ...
        <table class="table table-bordered" id="result-kabkot-table-rekon">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="result-kabkot primer" id="primer_rekon_Q1"></td>
                    <td class="result-kabkot primer" id="primer_rekon_Q2"></td>
                    <td class="result-kabkot primer" id="primer_rekon_Q3"></td>
                    <td class="result-kabkot primer" id="primer_rekon_Q4"></td>
                    <td class="result-kabkot primer" id="primer_rekon_total"></td>
                </tr>
                <tr>
                    <td class="desc-col">
                        <label class="mb-0">
                    ...
                    <td class="result-kabkot sekunder" id="sekunder_rekon_Q1"></td>
                    <td class="result-kabkot sekunder" id="sekunder_rekon_Q2"></td>
                    <td class="result-kabkot sekunder" id="sekunder_rekon_Q3"></td>
                    <td class="result-kabkot sekunder" id="sekunder_rekon_Q4"></td>
                    <td class="result-kabkot sekunder" id="sekunder_rekon_total"></td>
                </tr>
                <tr>
                    <td class="desc-col">
                        <label class="mb-0">
                    ...
                    <td class="result-kabkot tersier" id="tersier_rekon_Q1"></td>
                    <td class="result-kabkot tersier" id="tersier_rekon_Q2"></td>
                    <td class="result-kabkot tersier" id="tersier_rekon_Q3"></td>
                    <td class="result-kabkot tersier" id="tersier_rekon_Q4"></td>
                    <td class="result-kabkot tersier" id="tersier_rekon_total"></td>
                </tr>
