<div>
    <div class="card">
        <form method="post" enctype="multipart/form-data" id="filterForm" class="form-horizontal">
            <!-- form start -->
            <div class="card-body">

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="type">PDRB:</label>
                    <select id="type" class="form-control col-sm-8 select2bs4" name="type" required>
                ...
                <div class="form-group row">
                    ...
                    <select id="year" class="form-control col-sm-8 select2bs4" name="year" required>
                ...
                <div class="form-group row">
                    ...
                    <select id="quarter" class="form-control col-sm-8 select2bs4" name="quarter" required>
                ...
                <div class="form-group row">
                    ...
                    <select id="period" class="form-control col-sm-8 select2bs4" name="period_id" required>
                ...
                <div class="form-group row">
                    ...
                    <select id="region_id" class="form-control col-sm-8 select2bs4" name="region_id" required>
