                    ...
                    @foreach ($subsectors as $subsect)
                            ...
                            <tr>
                                ...
                                <td class="categories">
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->category->code . '_Q1' }}"
                                        id="adhk_{{ $subsect->sector->category->code . '_Q1' }}"
                                        class="form-control text-right" aria-required="true">
                                </td>
                                <td class="categories">
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->category->code . '_Q2' }}"
                                        id="adhk_{{ $subsect->sector->category->code . '_Q2' }}"
                                        class="form-control text-right" aria-required="true">
                                </td>
                                <td class="categories">
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->category->code . '_Q3' }}"
                                        id="adhk_{{ $subsect->sector->category->code . '_Q3' }}"
                                        class="form-control text-right" aria-required="true">
                                </td>
                                <td class="categories">
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->category->code . '_Q4' }}"
                                        id="adhk_{{ $subsect->sector->category->code . '_Q4' }}"
                                        class="form-control text-right" aria-required="true">
                                </td>
                                <td class="categories">
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->category->code . '_Y' }}"
                        ...
                        @if ($subsect->code != null && $subsect->code == 'a')
                            <tr>
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q1' }}"
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q2' }}"
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q3' }}"
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q4' }}"
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->sector->code . '_' . $subsect->sector->category->code . '_Y' }}"
                        ...
                        @if ($subsect->code != null)
                            <tr>
                                ...
                                <td>
                                    <input type="text"
                                        name="adhk_{{ $subsect->code . '_' . $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q1' }}"
                                ...
                                <td>
                                    <input type="text"
                                        name="adhk_{{ $subsect->code . '_' . $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q2' }}"
                                ...
                                <td>
                                    <input type="text"
                                        name="adhk_{{ $subsect->code . '_' . $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q3' }}"
                                ...
                                <td>
                                    <input type="text"
                                        name="adhk_{{ $subsect->code . '_' . $subsect->sector->code . '_' . $subsect->sector->category->code . '_Q4' }}"
                                ...
                                <td>
                                    <input disabled type="text"
                                        name="adhk_{{ $subsect->code . '_' . $subsect->sector->code . '_' . $subsect->sector->category->code . '_Y' }}"
