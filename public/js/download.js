...
async function downloadExcel() {
    ...
    try {
        ...
        var worksheet = XLSX.utils.json_to_sheet(list['sdalam_json']);
    ...
    //     //laju-ytoy
    //     let firstY = getIndex(data.data, "lapangan");
    //     let beforeY = getIndex(data.before, "lapangan");
    ...
    //     //laju-ytoy
    //     let firstC = getIndex(data.data, "lapangan");
    //     let beforeC = getIndex(data.before, "lapangan");
    //     getLaju(firstC, beforeC);
    //     list["lajuC_json"] = getReady();
    // }
    //     },
    //     error: function (jqXHR, textStatus, errorThrown) {
    //         alert("Data tahun lalu mungkin tidak ada, atau pilihan salah");
    //     },
    // });
}
